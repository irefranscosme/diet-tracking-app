...
export const metadata = {
    title: 'Meals | Breakfast - Diet Tracking App',
    description: 'Meals | Breakfast - Diet Tracking App Descripition',
};

// TODO: fetch the overall total of the user macros today.
// TODO: issue can't click anything after redirection. work around is to reload.
const Page = () => {
    return (
        <div className="space-y-8 max-w-4xl flex flex-col items-center justify-center h-full mx-auto">
            ...
            <BackButton route={routes.meals} title={'Meals'} />
        </div>
    );
};
